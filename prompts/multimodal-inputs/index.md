...
The [`ContentPart`](https://api.koog.ai/prompt/prompt-model/ai.koog.prompt.message/-content-part/index.html) class lets you configure media content parameters for each attachment individually.

...
Koog uses the type-safe Kotlin DSL to create structured prompts with control over message types, their order, and content.

The structured prompts let you pre-configure conversation history with multiple messages, provide multimodal content, examples, tool calls, and their results.
...
A user message represents input from the user. It can include plain text or multimodal content (such as images, audio, video, and documents).
...
- Learn how to work with [multimodal content](../multimodal-inputs/).
